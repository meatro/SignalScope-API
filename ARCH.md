...
- `CAN/runtime core` (`kCanCore = 1`): ingress polling, gateway queue drain, mutation apply, replay tick.
- `UI/server core` (`kUiCore = 0`): HTTP server handlers and web-client polling.
